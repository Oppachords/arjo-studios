...
const fallbackProjects = [
  ...
  },
  {
    ...
    folder: 'INYANGE',
    coverImageUrl: '/images/INYANGE/INYANGE-INDUSTRIES-VISUALArtboard-1.png',
  ...
  },
  {
    ...
    title: 'SUPREME',
    folder: 'SUPREME',
    coverImageUrl: '/images/SUPREME/PRESENTATIONArtboard-1.png',
  ...
  },
  {
    ...
    folder: 'UHURU',
    coverImageUrl: '/images/UHURU/Artboard 1.png',
...
export default function Works2() {
  ...
  const projectsData = projects.length > 0 ? projects : (loading ? [] : fallbackProjects);
